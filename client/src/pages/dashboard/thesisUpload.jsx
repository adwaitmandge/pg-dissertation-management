...
function ThesisUpload() {
  ...
  const selectMentor = (id) => {
    ...
    toast({
      ...
      description: "Thesis will be sent to this mentor",
      status: "success",
      duration: 5000,
      isClosable: true,
      position: "top-right",
    });
    // console.log("I am", user); // setSelectedUserId(user.to._id);
  };
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="md:mr- mr-auto mt-2 w-full flex-1 bg-white">
        <Input
        ...
        {loading ? (
          ...
          <div
            className={`absolute z-50 w-[900px] rounded-3xl bg-white ${
              showResults ? "" : "hidden"
            } p-4 shadow-lg`}
          >
      ...
      <div className="mb-3 w-full pt-11">
